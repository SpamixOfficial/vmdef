from vmdef import op, arg_handler, arg_formatter, ArgType, rad_lookup
...
@op(code=0x2, args=["rd1","rs1"], rad="args[0]=args[1]")
def mov(args):
    pass
...
@op(code=0x3, args=["rd1","is1"], rad="args[0]=args[1]")
def movi(args):
    pass
...
# NOTE: It also shares the same arguments as an args_handler, but should return a formatted string instead of a dictionary
@arg_formatter
def arg_prettifier(args):
    res = []
    for arg in args:
